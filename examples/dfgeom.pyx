...
cdef extern from "//home/dmarchal/projects/DEFROST/dev/sofa3/plugins/SofaImplicitField3/examples/vector.h" namespace "":
    cdef cppclass Vec3d:
            Vec3d()
...
cdef class Sphere(Shape):
        ...
        def toShapeTree(self, node):
                ...
                union.addData("center", [self.center.x, self.center.y, self.center.z], [0.0,0.0,0.0], "The position of the center of the Sphere", "Shape", "Vec3d")     
                union.addData("radius",  self.radius, 0.0, "The position of the center of the Sphere", "Shape", "float")     
                union.addData("ssai", self.name, "", "The unique shape identifier", "Shape", "string")     
                union.addData("ssai_vars", "center radius", "", "The unique shape identifier", "Shape", "string")                     
                return union
